    ...
    >
      <PanelSection title="Elevación">
        ...
        <div className="mt-2 grid grid-cols-2 gap-1.5 px-1 pb-1">
          <ActionButton label="Hundido (-15cm)" onClick={() => handleUpdate({ elevation: -0.15 })} />
          <ActionButton label="Nivel cero (0m)" onClick={() => handleUpdate({ elevation: 0 })} />
          <ActionButton label="Elevado (+5cm)" onClick={() => handleUpdate({ elevation: 0.05 })} />
          <ActionButton label="Escalón (+15cm)" onClick={() => handleUpdate({ elevation: 0.15 })} />
        </div>
      </PanelSection>
